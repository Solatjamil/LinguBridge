...
import { GraduationCap, ChevronLeft, Loader2, Target, Trophy, BookOpen, LayoutDashboard, Sparkles, Languages, Mic, MicOff } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [mode, setMode] = useState<'selection' | 'curriculum' | 'practice' | 'learn' | 'dashboard'>('selection');
